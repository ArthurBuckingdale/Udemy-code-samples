# -*- coding: utf-8 -*-
"""
Created on Sat Nov 16 11:05:07 2019

@author: ryanc
"""

#the purpose of this is to learn and apply the usage of an autoencoder to 
#determine if a user will like a film based on its reviews.
...
#creating the architecture for the auto encoder.
class SAE(nn.Module):
    def __init__(self, ):
        ...
        self.fc6 = nn.Linear(20,30)
        self.fc7 = nn.Linear(30,nb_movies)
...
#training the auto encoder. Should be fun
nb_epoch = 200

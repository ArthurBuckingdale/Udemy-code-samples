# -*- coding: utf-8 -*-
"""
Created on Thu Jan 30 19:28:45 2020
...
#initislize and setting the variance of a tensor of weights
...
#initialize the weights of the neural network for an optimal learning 
def weights_init(m):
